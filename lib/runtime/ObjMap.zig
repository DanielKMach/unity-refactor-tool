...
pub fn new(self: *ObjMap, guid: GUID, file_id: u64, class_id: u32) !*yaml.Document {
...
pub fn get(self: *const ObjMap, guid: GUID, file_id: u64) ?Entry {
    ...
    return .{
        ...
        .main = yaml.getNode(def.doc, def.doc.nodes.start.*, classId2Key(def.class_id)) orelse @panic("invalid main node"),
    };
}
...
pub fn classId2Key(class_id: u32) []const u8 {
